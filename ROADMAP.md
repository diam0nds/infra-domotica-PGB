...
| ~~3~~ | ✅ **FATTO 2026-08-11** — `IoTZone input=REJECT` + regola **nominata** `firewall.iotsvc` che permette `53 67 68 123` | Misurato prima: i dispositivi IoT contattano il router **solo sulla 53**. Aggiunti i permessi *prima* di chiudere. Catena verificata: ACCEPT precedono il REJECT finale. Osservati 180 s: 1 pacchetto accettato su :53, **0 rifiuti**. ⚠️ Finestra breve: se un dispositivo smette di funzionare, il contatore `zone_IoTZone_src_REJECT` lo rivela |
